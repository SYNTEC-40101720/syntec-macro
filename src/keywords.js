...
exports.keywords = {
  ...
  gcodes: [
    ...
    'G68.18','G141.1','G141.2','G142.1','G142.101','G142.102','G142.2','G142.3','G143.1',
    'G144.1','G144.2','G144.103','G144.104','G145.1','G145.2','G190.1','G190.2',
    'G191.1','G191.2','G192.1','G192.2','G193.101','G196','G903','G1.15','G1.16','G2.15','G4.15','G11.15',
    'G11.16','G11.17','G31.15','G43.15','G52.15','G52.16','G52.17','G52.20','G52.21',
    'G53.15','G53.16','G53.17','G53.18','G68.15'
  ],
  mcodes: [
...
exports.keywordDocs = {
  ...
  'NOT': {
    sig: 'NOT 数值',
    doc: '数值补数运算符，结果等同于 -(数值 + 1)。布林 0/1 取反建议用 1 - 变量；单 bit 或指定字宽翻转建议用 XOR mask。'
  },
  'MOD': {
    sig: '数值1 MOD 数值2',
