...
> 插件状态与后续动作见 [能力矩阵](MACRO能力矩阵.md) 对应能力 ID(FUN-003)。本资料包独有细节(`ALARM` 清除机制、`MSG` ESC/自动消失与预设 ID 版本差异)已回填到 [语法规范手册 §9.10](../新代MACRO语法规范手册.md#910-讯息与警報函数);本资料包转为运行时验证记录+审计归档。
## 1. 函数能力矩阵
