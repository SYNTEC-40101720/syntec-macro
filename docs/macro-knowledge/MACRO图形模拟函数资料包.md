...
> 插件状态与后续动作见 [能力矩阵](MACRO能力矩阵.md) 对应能力 ID(FUN-001)。本资料包独有细节(RGB `0xFF0000` ↔ BGR `0x0000FF=255` 示例与 `DRAWHOLE` 后原色回写恢复顺序)已回填到 [语法规范手册 §9.12](../新代MACRO语法规范手册.md#912-图形模拟函数);本资料包转为运行时验证记录+审计归档。
## 1. 函数能力矩阵
...
| 验证 ID | 机型 | 软件版本 | @变量实际值 | 结论 | 日期 |
| --- | --- | --- | --- | --- | --- |
| FUN-F-03 | 81RA | 10.120.44C | @1=255 | SETDRAW 成功返回入参 | 2026-07-28 |
| FUN-F-04 | 81RA | 10.120.44C | @1=16777215, @2=255, @3=-1, @4=99999999 | SETDRAW 原样返回入参，不做有效性检查；超界值/-1均无报警 | 2026-07-28 |
