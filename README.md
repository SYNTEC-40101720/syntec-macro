...
![Version](https://img.shields.io/badge/version-2.11.5-blue)
![Downloads](https://img.shields.io/vscode-marketplace/d/syntec-team.syntec-macro)
![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20Linux%20%7C%20macOS-lightgrey)

为新代（SYNTEC）CNC 宏程序提供语法高亮、补全、悬停说明、代码跳转和实时诊断。

## 安装

1. 从 [GitHub Releases](https://github.com/SYNTEC-40101720/syntec-macro/releases) 下载最新的 `.vsix` 文件。
2. 在 VS Code 中按 `Ctrl+Shift+P`，执行 `Extensions: Install from VSIX...`。
3. 选择下载的文件并重新加载窗口。
...
- [控制器语法规范](docs/新代MACRO语法规范手册.md)
- [更新记录](CHANGELOG.md)

## 反馈

- [提交 Issue](https://github.com/SYNTEC-40101720/syntec-macro/issues)
- [GitHub Discussions](https://github.com/SYNTEC-40101720/syntec-macro/discussions)
# SYNTEC 宏程序 VS Code 扩展
